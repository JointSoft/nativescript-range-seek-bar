...
export class RangeSeekBar extends RangeSeekBarBase {
	...
	public createNativeView() {
		const crystalRangeSeekBar =
			new com.crystal.crystalrangeseekbar.widgets.CrystalRangeSeekbar(
				this._context
			);
		crystalRangeSeekBar.setDataType(
			com.crystal.crystalrangeseekbar.widgets.CrystalRangeSeekbar.DataType.LONG
		);
		...
		const rangeSeekbarChangeListener = new RangeSeekbarChangeListener(
			new WeakRef<RangeSeekBar>(this)
		);
		crystalRangeSeekBar.setOnRangeSeekbarChangeListener(
			rangeSeekbarChangeListener
		);
		initRangeSeekbarFinalValueListener();
		const rangeSeekbarFinalValueListener = new RangeSeekbarFinalValueListener(
			new WeakRef<RangeSeekBar>(this)
		);
		crystalRangeSeekBar.setOnRangeSeekbarFinalValueListener(
			rangeSeekbarFinalValueListener
		);
	...
	public [stepProperty.setNative](value: number) {
		if (Number.isInteger(value)) {
			this.nativeView.setDataType(
				com.crystal.crystalrangeseekbar.widgets.CrystalRangeSeekbar.DataType
					.LONG
			);
		} else {
			this.nativeView.setDataType(
...
interface RangeSeekbarChangeListener
	extends java.lang.Object,
		com.crystal.crystalrangeseekbar.interfaces.OnRangeSeekbarChangeListener {
...
function initRangeSeekbarChangeListener() {
	...
	class RangeSeekbarChangeListenerImpl
		extends java.lang.Object
		implements
			com.crystal.crystalrangeseekbar.interfaces.OnRangeSeekbarChangeListener
	{
...
interface RangeSeekbarFinalValueListener
	extends java.lang.Object,
		com.crystal.crystalrangeseekbar.interfaces
...
function initRangeSeekbarFinalValueListener() {
	...
	@NativeClass()
	@Interfaces([
		com.crystal.crystalrangeseekbar.interfaces.OnRangeSeekbarFinalValueListener,
	])
	class RangeSeekbarFinalValueListenerImpl
		extends java.lang.Object
		implements
			com.crystal.crystalrangeseekbar.interfaces
				.OnRangeSeekbarFinalValueListener
